...
public class PostRequestSender {
    ...
    public PostRequestSender(ArrayList<Float[]> reSpeckSensorDataList) {
        ...
        for (Float[] dataPoint : reSpeckSensorDataList) {
            dataArray.add(respeckDataToList(dataPoint));
        }

        this.dataForJson = dataArray.toArray(new String[0][]);
    }


    //converts a RESpeckSensorData object to a list of strings
    private static String[] respeckDataToList(Float[] data) {

        String accel_x = Float.toString(data[0]);
        String accel_y = Float.toString(data[1]);
        String accel_z = Float.toString(data[2]);

        String gyro_x = Float.toString(data[3]);
        String gyro_y = Float.toString(data[4]);
        String gyro_z = Float.toString(data[5]);
...
//        new Thread(() -> {
//            try {
//                String thing = performNetworkRequest();
//                // Pass the result to the callback
//                callback.onRequestComplete(thing);
//            } catch (IOException e) {
//                e.printStackTrace();
...
//    }
    ...
    public String performNetworkRequest() throws IOException {
        String thing;
        URL url = new URL("http://iestynmullinor.pythonanywhere.com/predict");
